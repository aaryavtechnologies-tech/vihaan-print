...
export function replacePlaceholders(text: string, studentData: Record<string, any>): string {
  ...
  const map: Record<string, string> = {
    "student name": studentData.student_name || studentData.name || "",
    ...
    "admission number": studentData.admission_number || studentData.admission_no || "",
    "admission_number": studentData.admission_number || studentData.admission_no || "",
    "dob": studentData.dob || "",
    "blood group": studentData.blood_group || "",
    "blood_group": studentData.blood_group || "",
    "mobile": studentData.mobile || studentData.student_mobile || "",
    "address": studentData.address || studentData.addressLine1 || "",
