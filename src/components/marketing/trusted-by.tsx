export function TrustedBy() {
  ...
  return (
    <section className="py-12 border-y bg-white dark:bg-slate-950 overflow-hidden">
      <div className="container mx-auto px-4 max-w-7xl text-center">
        ...
        <div className="flex flex-wrap justify-center items-center gap-8 md:gap-16 opacity-70 transition-all duration-500">
          {logos.map((logo, index) => (
            <div key={index} className="text-lg md:text-xl font-bold text-slate-800 dark:text-slate-200">
              {logo}
            </div>
          ))}
        </div>
