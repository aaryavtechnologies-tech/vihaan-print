...
function DropdownMenuTrigger({ asChild, children, ...props }: MenuPrimitive.Trigger.Props & { asChild?: boolean }) {
  if (asChild && React.isValidElement(children)) {
    return <MenuPrimitive.Trigger data-slot="dropdown-menu-trigger" {...props} render={children} />
  }
...
function DropdownMenuItem({
  ...
  if (asChild && React.isValidElement(children)) {
    return <MenuPrimitive.Item {...itemProps} render={children as React.ReactElement} />
  }

  return (
    <MenuPrimitive.Item {...itemProps}>
      {children}
    </MenuPrimitive.Item>
  )
}
